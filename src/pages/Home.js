      ...
      <div className='w-screen'>
        ...
        <section id='intro' className='h-screen pt-24 sm:pt-1 md:pt-1 bg-theme'>
          ...
          border-white '>
            ...
            <div className='font-bold text-white sm:-mt-10 md:px-5 sm:place-self-center md:place-self-start -mt-32'>
              <h1
        ...
        <section id='projects'>
          ...
          <div className='grid mt-10 md:grid-cols-1 grid-cols-2 items-center justify-center gap-10 mx-20 md:mx-5'>
            {projectsData.map((project) => {
              return (
                <div key={project.title}>
                  <div className='relative p-4 border-2 text-center rounded-tr-3xl rounded-bl-3xl border-gray-400'>
                    <img
                      src={project.image}
                      alt='project1'
                    ...
                    <div className='absolute inset-0 flex items-center justify-center flex-col opacity-0 bg-black hover:opacity-80 rounded-tr-3xl rounded-bl-3xl'>
                      ...
                      <p className='font-light text-white p-2'>
                        {project.description}
                      </p>
          ...
          <div className='mt-14 sm:-mt-32 md:-mt-24'>
            <div className='sm:w-screen w-4/5 h-80% md:h-fit p-10 shadow-2xl bg-gray-50'>
              ...
              <form
                ...
                <button className='bg-yellow-600 rounded text-white px-5 py-1 mt-3 cursor-pointer hover:bg-yellow-700'>
                  SUBMIT
                </button>
              </form>
            </div>
